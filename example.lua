--!strict
-- example.lua — the coreui demo, written in the TARGET Luau API.
-- Build the library until THIS script runs and looks like reference/coreui-demo.html.
-- (Build target / spec — the library it requires is what you are creating.)
