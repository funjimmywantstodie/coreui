...
local C = {accent=Color3.fromHex("7BE04A"),accent_dim=Color3.fromHex("4E9B2B"),accent_fill=Color3.fromHex("5EB832"),border=Color3.fromHex("2B3427"),border_soft=Color3.fromHex("1F271D"),card=Color3.fromHex("171D15"),chrome=Color3.fromHex("0B0F0A"),control=Color3.fromHex("1D241B"),control_hi=Color3.fromHex("262E23"),danger=Color3.fromHex("FF6B6B"),knockout=Color3.fromHex("08140A"),pop=Color3.fromHex("1A2118"),text=Color3.fromHex("E9F2E5"),text_dim=Color3.fromHex("616D5D"),text_muted=Color3.fromHex("98A394"),warning=Color3.fromHex("FFC53D")}
