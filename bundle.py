...
# bundle), but Krypton only ever resolves the handful of Lucide names listed in
...
def main():
    ...
    out = [
        ...
        f'-- build: {version}',
        f'print("[Krypton] build {version} loaded")',
